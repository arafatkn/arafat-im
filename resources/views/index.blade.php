...
<section id="home" class="home d-flex align-items-center">
	<div class="container">
		...
		<div class="intro">
			<!-- avatar image -->
			<img src="/assets/images/arafatkn.png" alt="Arafat" class="mb-4" />

			<!-- info -->
			<h1 class="mb-2 mt-0">Arafat Islam</h1>
			<span>I'm a <span class="text-rotating">Full Stack Web Developer, PHP/Laravel Developer, Vue/Nuxt Developer</span></span>

			<!-- social icons -->
			<ul class="social-icons light list-inline mb-0 mt-4">
				<li class="list-inline-item"><a href="https://facebook.com/arafatkn" target="_blank"><i class="fab fa-facebook"></i></a></li>
				<li class="list-inline-item"><a href="https://twitter.com/arafatkn" target="_blank"><i class="fab fa-twitter"></i></a></li>
				<li class="list-inline-item"><a href="https://linkedin.com/in/arafatkn" target="_blank"><i class="fab fa-linkedin"></i></a></li>
				<li class="list-inline-item"><a href="https://github.com/arafatkn" target="_blank"><i class="fab fa-github"></i></a></li>
				<li class="list-inline-item"><a href="mailto:arafatkn@gmail.com" target="_blank"><i class="fa fa-envelope"></i></a></li>
			</ul>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="text-center text-md-left">
					<!-- avatar image -->
					<img src="/assets/images/arafatkn-2.png" alt="Arafat" />
				</div>
				...
				<div class="rounded bg-white shadow-dark padding-30">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="mt-3">
								<a href="/files/Resume%20of%20arafatkn.pdf" class="btn btn-default">Download Resume</a>
							</div>
							<div class="spacer d-md-none d-lg-none" data-height="30"></div>
						</div>
						<div class="col-md-6">
							...
							<div class="skill-item">
								<div class="skill-info clearfix">
									<h4 class="float-left mb-3 mt-0">System Administration</h4>
			...
			<div class="col-md-3 col-sm-6">
				...
				<div class="fact-item">
					...
					<div class="details">
						...
						<p class="mb-0">Full Projects completed</p>
					</div>
				</div>
				<div class="spacer d-md-none d-lg-none" data-height="30"></div>
			</div>
			...
			<div class="col-md-3 col-sm-6">
				...
				<div class="fact-item">
					...
					<div class="details">
						...
						<p class="mb-0">Bug Fixing, Customization</p>
					</div>
				</div>
				<div class="spacer d-md-none d-lg-none" data-height="30"></div>
			</div>
			...
			<div class="col-md-3 col-sm-6">
				...
				<div class="fact-item">
					...
					<div class="details">
						...
						<p class="mb-0">National award winner</p>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="service-box rounded data-background padding-30 text-center text-light shadow-blue" data-color="#6C6CE5">
					<img src="/assets/images/service-2.svg" alt="Backend Development" />
					<h3 class="mb-3 mt-0">Backend Development</h3>
					<p class="mb-0">Laravel, Lumen, Botman, Raw PHP, Wordpress, Woocommerce, MySQL, MariaDB, Redis.</p>
				</div>
				<div class="spacer d-md-none d-lg-none" data-height="30"></div>
			</div>
			...
			<div class="col-md-6">
				...
				<div class="service-box rounded data-background padding-30 text-center text-light shadow-pink" data-color="#F97B8B">
					<img src="/assets/images/service-1.svg" alt="Frontend Development" />
					<h3 class="mb-3 mt-0">Frontend Development</h3>
					<p class="mb-0">HTML, CSS, Javascript, Bootstrap, jQuery, VueJS, NuxtJS.</p>
				</div>
			</div>
		...
		<div class="row">
				...
				<div class="timeline edu bg-white rounded shadow-dark padding-30 overflow-hidden">
					...
					<div class="timeline-container wow fadeInUp">
						<div class="content">
							...
							<h3 class="title">B.Sc. (Engineering) in CSE</h3>
							<p>Pabna University of Science and Technology (PUST), Pabna</p>
						</div>
					</div>
					...
					<div class="timeline-container wow fadeInUp" data-wow-delay="0.2s">
						<div class="content">
							...
							<p>Major General Mahmudul Hasan Ideal College, Tangail</p>
						</div>
					</div>
					...
					<div class="timeline-container wow fadeInUp" data-wow-delay="0.4s">
						<div class="content">
							...
							<p>Bindubashini Govt. Boys High School, Tangail</p>
						</div>
					</div>
			...
			<div class="col-md-6">
				...
				@foreach($experiences as $item)
					...
					<div class="timeline-container wow fadeInUp">
						<div class="content">
							<span class="time">{{ $item->joined_at->format('M Y') }} - {{ $item->quit_at?$item->quit_at->format('M Y'):'Present' }}</span>
...
<section id="experience">
	...
	<div class="container">
		...
		<!-- section title -->
		<h2 class="section-title wow fadeInUp">Awards</h2>
				...
				<div class="timeline edu bg-white rounded shadow-dark padding-30 overflow-hidden">
					...
					<div class="timeline-container wow fadeInUp">
						<div class="content">
							...
							<h3 class="title">Banglalink IT Incubator 3.0</h3>
							<p>Champion (National Top 7)</p>
							<p>Team: MessBook</p>
						</div>
					</div>
					...
					<div class="timeline-container wow fadeInUp" data-wow-delay="0.2s">
						<div class="content">
							...
							<h3 class="title">Student 2 Startup - Chapter 2</h3>
							<p>Runner Up</p>
							<p>Team: MessBook.xyz</p>
						</div>
					</div>
			...
			<div class="col-md-6">
				...
				<div class="timeline edu bg-white rounded shadow-dark padding-30 overflow-hidden">
					...
					<div class="timeline-container wow fadeInUp" data-wow-delay="0.4s">
						<div class="content">
							<span class="time">2019</span>
							<h3 class="title">BASIS National ICT Award 2019</h3>
							<p>1st Runner Up</p>
							<p>Team: MessManager</p>
						</div>
					</div>
...
<section id="testimonials">
	...
	<div class="container">
		...
		<!-- section title -->
		<h2 class="section-title wow fadeInUp">{{ count($testimonials)?'Clients & Reviews':'Clients' }}</h2>
		...
		@foreach($testimonials as $item)
			...
			<div class="testimonial-item text-center mx-auto">
				<div class="thumb mb-3 mx-auto">
					<img src="/assets/images/avatar-3.svg" alt="{{ $item->name }}" />						
				</div>
				<h4 class="mt-3 mb-0">{{ $item->name }}</h4>
				<span class="subtitle">{{ $item->identity}}</span>
		...
		@foreach ($clients as $item)
			<div class="col-lg-2 col-md-3 col-sm-4 col-6">
				...
				<div class="client-item">
					<div class="inner">
						<img src="{{ str_replace('public','storage',  $item) }}" alt="" />
					</div>
				</div>
			</div>
		@endforeach
...
<section id="contact">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<!-- Contact Form -->
				<form id="contact-form" class="contact-form mt-6" method="post" action="/contact">@csrf
					...
					<div class="row">
						...
						<div class="column col-md-12">
							<!-- Email input -->
							<div class="form-group">
								<input type="text" class="form-control" id="InputSubject" name="subject" placeholder="Subject" required="required" data-error="Subject is required.">
								<div class="help-block with-errors"></div>
							</div>
						</div>
