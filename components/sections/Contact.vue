      ...
      <div class="row">
        <div class="col-md-4">
          <div class="contact-info">
            ...
            <p class="wow fadeInUp">Don't like forms? Send me an <a href="/cdn-cgi/l/email-protection#0668676b6346637e676b766a632865696b">email</a>. 👋</p>
          </div>
        </div>
        <div class="col-md-8">

          <form id="contact-form" class="contact-form mt-6" method="post" action="/contact"><input type="hidden" name="_token" value="ssyYoF3B7fjGWGGI71NuG6YyimxA2oUEj0zMOAjp">
